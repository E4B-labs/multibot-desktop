...
import { canRemember, copyText, forgetRemembered, isOnionHost, isReactNativeShell, joinLocalHarness, rememberedEntry, rememberProfile, resolveHost, signInRemembered, type RememberedEntry } from "@/lib/shell";
